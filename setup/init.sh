...
userarn=$(aws iam get-user --user-name github-action-user --profile udacity | jq -r .User.Arn)
...
./aws-iam-authenticator add user --userarn="${userarn}" --username=github-action-role --groups=system:masters --kubeconfig=/home/anhvk31/.kube/config --prompt=false
